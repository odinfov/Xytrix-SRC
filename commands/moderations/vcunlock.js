...
module.exports = {
    ...
    category: 'mod',
    aliases: [],
    description: `Unlocks a voice channel. Usage: vcunlock [channelID]`,
    premium: false,
    ...
    run: async (client, message, args) => {
        ...
        if (!channel.manageable) {
            return message.channel.send({
                embeds: [new MessageEmbed()
                    .setColor(client.color)
                    .setDescription(`I don't have adequate permissions to unlock this voice channel.`)]
            });
        }
        ...
        return message.channel.send({
            embeds: [new MessageEmbed()
                .setDescription(`${client.emoji.tick} **${channel.name}** has been successfully unlocked for @everyone.`)
                .setColor(client.color)]
        });
    }
};
