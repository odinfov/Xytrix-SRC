...
module.exports = {
    ...
    description: `Enables automated assignment of custom roles to specified users.`,
        ...
        if (input === 'add') {
            ...
            if (!data) {
                ...
                const setupRoleEmbed = new MessageEmbed()
                    ...
                    .setDescription(
                        `Your server has been configured successfully. You can now use custom roles and enjoy the enhanced features of custom roles.`
                    )
                    .setFooter(
            ...
            if (data) {
                ...
                return Xytrix(embed, client, message)
            }
        } else if (input == 'reset') {
            const data = await client.db?.get(`customrole_${message.guild.id}`)
            if (!data) {
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        ...
                        .setDescription(
                            `The custom role module has been successfully reset. All custom role setups have been cleared.`
                        )
                        .setFooter(
            ...
            if (
                !isSpecialMember && role.position >= message.member.roles.highest.position &&
            ...
            let reqrole, girl, guest, vip, friend
...
async function Xytrix(embed, client, message) {
    let embeds = [],
        page = 0,
        i,
        k
