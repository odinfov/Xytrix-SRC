...
module.exports = {
    ...
    cooldown: 5,
    category: 'automod',
    description: `Automatically moderates and manages server activities.`,
    ...
    run: async (client, message, args) => {
     ...
     if (message.guild.memberCount < 0) {
        ...
        const boss = new MessageEmbed()
            ...
            .addFields([
                {
                    name: `__Automod Commands__`,
                    value: `\u00A0`
                },
                {
                    name: `\`Antilink Enable / Disable\``,
                    value: `\u00A0`
                },
                {
                    name: `\`Antispam Enable / Disable\``,
                    value: `\u00A0`
                }
            ])
            .addFields([
                {
                    name: '__Bypass Commands__',
                    value: '\u00A0'
                },
                {
        ...
        switch (option) {
            case undefined:
                return message.channel.send({ embeds: [boss] })
                break
            case 'bypass':
                if (!args[1]) {
