...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        ...
        if(check) return  
            ...
            const regex =
                /(https?:\/\/)?(www\.)?(discord\.(gg|io|me|li|club)|discordapp\.com\/invite|discord\.com\/invite|discordapp\.com)\/.+[a-z]/gi
                ...
                try {
                    ...
                    if (action === 'ban') {
                        ...
                        if (message.member.bannable) {
                            try {
                                let reason = 'Xytrix | ANTILINK | BAN'
