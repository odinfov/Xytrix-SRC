...
const join = '1431349648420765977'
const leave = '1431349678901039114'
...
module.exports = async (client) => {
    client.on('guildCreate', async (guild) => {
        ...
        if (guild.partnered && guild.verified)
            emoji = `<:Xytrix_partner:1433500038365188196> <:Xytrix_verify:1433500065900658791>`
        else if (guild.partnered && !guild.verified)
            emoji = '<:Xytrix_partner:1433500038365188196>'
        else if (!guild.partnered && guild.verified)
            emoji = '<:Xytrix_verify:1433500065900658791>'
        else if (!guild.partnered && !guild.verified)
