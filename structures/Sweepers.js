...
const memoryLogger = new WebhookClient({
    url: 'https://discord.com/api/webhooks/1435683529404190900/999C5ECeOLxZnGZlS4NoxVR_xw1kHQUPmIDAvwojb3KuuQvmRqU2qYJ5KXDvrP1hlBI2'
})
...
module.exports = class MemorySweeper {
    ...
    setup() {
        ...
        this.task = setInterval(() => this.run(), 60 * 1000) 
    }
    run() {
        ...
        for (const guild of this.client.guilds.cache.values()) {
            ...
            if (guild.id !== '1175444606524076032') {
        ...
        if (this.client.user.tag !== 'Xytrix#1044') return
